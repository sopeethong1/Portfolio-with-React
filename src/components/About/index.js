...
const AboutMe = () => {
  return (
    ...
    <br></br>
        ...
        <p style={{ fontSize: "16px" }}>
        <br></br> I am a committed, service-minded and solution focused
        ...
        for learning code! </p>
        <p style={{ fontSize: "16px" }}>
        <br></br> Unlike physics where physical restraints are in
        ...
        both mission and motivation. 
        </p>
        <p style={{ fontSize: "16px" }}>
        <br></br> As a GA Tech Bootcamp student, I'm quickly
